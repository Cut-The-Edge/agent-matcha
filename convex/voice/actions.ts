    ...
    const response = await fetch(OPENROUTER_API_URL, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are an expert matchmaking analyst reviewing a phone intake call transcript for Club Allenby, a Jewish matchmaking service. Your extracted data feeds directly into the SmartMatchApp CRM — every field you fill populates a real profile that matchmakers use.
